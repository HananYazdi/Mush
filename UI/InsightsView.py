...
class InsightsView(QMainWindow):
    ...
    def __init__(self, batches, logs):
        ...
        self.setWindowTitle("Farm Insights")
    ...
    def setup_visualizations_tab(self):
        ...
        # Main layout
        main_layout = QVBoxLayout(self.visualizations_tab)
        main_layout.setContentsMargins(0, 0, 0, 0)
        
        # Add a prominent heading at the top (outside scroll area)
        main_title = QLabel("📊 VISUALIZATION DASHBOARD 📊")
        ...
        # Create scroll area for the visualizations
        ...
        # Label to explain visualizations
        self.visuals_label = QLabel("These visualizations provide graphical insights into your farm data. Click the buttons below each graph to see them in full size or learn about the analysis methods.")
        self.visuals_label.setWordWrap(True)
        self.visuals_label.setStyleSheet("margin-bottom: 15px; font-size: 16px;")
        layout.addWidget(self.visuals_label)
        
        # Add a section for mushroom yield predictions using decision tree
        ...
        # Button to open decision tree in new window
        self.decision_tree_button = QPushButton("Open Decision Tree in New Window")
        self.decision_tree_button.setVisible(False)
        self.decision_tree_button.clicked.connect(self.show_decision_tree_popup)
        dt_layout.addWidget(self.decision_tree_button, alignment=Qt.AlignCenter)
        
        # How it works button for decision tree
        ...
        separator.setStyleSheet("background-color: #3498db; max-height: 1px;")
        layout.addWidget(separator)
        
        # Feature importance visualization
        self.feature_importance_label = QLabel("📊 Factors Affecting Yield")
        ...
        self.feature_importance_image = QLabel("Loading visualization...")
        self.feature_importance_image.setAlignment(Qt.AlignCenter)
        fi_layout.addWidget(self.feature_importance_image)
        
        # Button for opening in new window
        self.feature_btn = QPushButton("Open in New Window")
        self.feature_btn.setVisible(False)
        self.feature_btn.clicked.connect(self.show_feature_importance_popup)
        fi_layout.addWidget(self.feature_btn, alignment=Qt.AlignCenter)
        
        # How it works button
        self.feature_info_button = QPushButton("How This Analysis Works")
        self.feature_info_button.setStyleSheet("""
            QPushButton {
                background: qlineargradient(x1:0, y1:0, x2:1, y2:0,
                    stop:0 #16a085, stop:1 #1abc9c);
                color: white;
        ...
        """)
        self.feature_info_button.clicked.connect(lambda: self.show_algorithm_explanation('yield_factor'))
        fi_layout.addWidget(self.feature_info_button, alignment=Qt.AlignCenter)
        ...
        separator2.setStyleSheet("background-color: #3498db; max-height: 1px;")
        layout.addWidget(separator2)
        
        # Seasonal patterns visualization
        self.seasonal_label = QLabel("🌡️ Seasonal Patterns")
        ...
        self.seasonal_image = QLabel("Loading visualization...")
        self.seasonal_image.setAlignment(Qt.AlignCenter)
        seasonal_layout.addWidget(self.seasonal_image)
        
        # Button for opening in new window
        self.seasonal_btn = QPushButton("Open in New Window")
        self.seasonal_btn.setVisible(False)
        self.seasonal_btn.clicked.connect(self.show_seasonal_popup)
        seasonal_layout.addWidget(self.seasonal_btn, alignment=Qt.AlignCenter)
        
        # How it works button
        self.seasonal_info_button = QPushButton("How This Analysis Works")
        self.seasonal_info_button.setStyleSheet("""
            QPushButton {
                background: qlineargradient(x1:0, y1:0, x2:1, y2:0,
                    stop:0 #16a085, stop:1 #1abc9c);
                color: white;
        ...
        """)
        self.seasonal_info_button.clicked.connect(lambda: self.show_algorithm_explanation('seasonal'))
        seasonal_layout.addWidget(self.seasonal_info_button, alignment=Qt.AlignCenter)
        ...
        separator3.setStyleSheet("background-color: #3498db; max-height: 1px;")
        layout.addWidget(separator3)
        
        # Harvest timeline visualization
        self.harvest_timeline_label = QLabel("🍄 Harvest Timeline")
        self.harvest_timeline_label.setObjectName("section_title")
        layout.addWidget(self.harvest_timeline_label)
        
        self.harvest_container = QWidget()
        self.harvest_container.setStyleSheet("padding: 10px; margin: 5px;")
        harvest_layout = QVBoxLayout(self.harvest_container)
        
        self.harvest_timeline_image = QLabel("Loading visualization...")
        self.harvest_timeline_image.setAlignment(Qt.AlignCenter)
        harvest_layout.addWidget(self.harvest_timeline_image)
        
        # Button for opening in new window
        self.harvest_btn = QPushButton("Open in New Window")
        self.harvest_btn.setVisible(False)
        self.harvest_btn.clicked.connect(self.show_harvest_popup)
        harvest_layout.addWidget(self.harvest_btn, alignment=Qt.AlignCenter)
        
        # How it works button
        self.harvest_info_button = QPushButton("How This Analysis Works")
        self.harvest_info_button.setStyleSheet("""
            QPushButton {
                background: qlineargradient(x1:0, y1:0, x2:1, y2:0,
                    stop:0 #16a085, stop:1 #1abc9c);
                color: white;
        ...
        """)
        self.harvest_info_button.clicked.connect(lambda: self.show_algorithm_explanation('harvesting'))
        harvest_layout.addWidget(self.harvest_info_button, alignment=Qt.AlignCenter)
        
        layout.addWidget(self.harvest_container)
        ...
        try:
            ...
            try:
                ...
                if features_plot:
                    ...
                    self.feature_btn.setVisible(True)
                else:
            ...
            try:
                ...
                if seasonal_plot:
                    ...
                    self.seasonal_btn.setVisible(True)
                else:
